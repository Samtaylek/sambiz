            ...
            <div class="modal-content modal-lg">
                ...
                <div class="modal-body">
                    ...
                    <form action="thankYou.php" method="post" id="payment-form">
                        ...
                        <input type="hidden"  name="description" value="<?=$item_count.' item'.(($item_count > 1)?'s':'').' from Majog Nigeria.';?>">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="checkout_button" style=" display:none; margin-bottom:10px;">Check Out >></button>
                    </form>
                </div>
            </div>
        </div>
...
<script>
    ...
    function check_address() {
        ...
        jQuery.ajax({
           url : '/SamBiz/admin/parsers/check_address.php',
            method : 'POST',
            data : data,
