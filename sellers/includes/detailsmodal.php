                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="center-block" style="margin-left: 20px;">
                                <img src="<?= $product['image']; ?>" alt="<?= $product['title']; ?>" class="details img-responsive" style="height: 300px; width:auto;">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <h4>Details</h4>
...
<!--                            <p>Brand : --><?//= $brand['brand']; ?><!--</p>-->
    ...
    <script>
        ...
        function closeModal() {
            jQuery('#details-modal').modal('hide').mouseleave('hide');
            setTimeout(function () {
                jQuery('#details-modal').remove('#details-modal');
